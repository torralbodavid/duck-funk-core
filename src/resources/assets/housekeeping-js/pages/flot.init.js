...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var pcolors = ['#f0f1f4', '#4090cb', '#e74c5e'];
          var borderColor = '#383c40';
          var bgColor = '#383c40';
          ...
          var datas = [20,30, 15];
          var colors = ['#4090cb','#e74c5e', "#ebeff2"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#e74c5e']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#f0f1f4', '#4090cb', '#e74c5e'];
